            ...
            for (final File fileEntry : folder.listFiles()) {
                ...
                if (fileEntry.isFile()) {
                    ...
                    //create a TemplateDomain object from the unmarsheller
                            JAXBElement<TemplateDomain> unmarshalledObject = ((JAXBElement<TemplateDomain>) unmarshaller.unmarshal(new ByteArrayInputStream(fileContent.getBytes(Charset.forName("UTF-8")
                    ))));
