...
public class ExecutionGeneratorValueHolder {
    ...
    public static void registerEventProcessorService(EventProcessorService eventProcessorService) {
        ExecutionGeneratorValueHolder.eventProcessorService = eventProcessorService;
    }

    public static void setRegistryService(RegistryService registryService) {
        ExecutionGeneratorValueHolder.registryService = registryService;
    }

    public static void unSetRegistryService() {
        ExecutionGeneratorValueHolder.registryService = null;
    }
